...
public:
   ...
   * @param _r - Valor que controla a quantidade de vermelho na cor (entre 0 e 1)
   * @param _g - Valor que controla a quantidade de verde na cor (entre 0 e 1)
   * @param _b - Valor que controla a quantidade de azul na cor (entre 0 e 1)
